...
hi Comment	guifg=cyan ctermfg=darkGray
hi Constant	guifg=#ff58b3 gui=bold ctermfg=lightMagenta
hi String	guifg=yellow gui=bold ctermfg=darkRed
hi Special	guifg=yellow gui=none ctermfg=darkRed
hi Identifier	guifg=red gui=none ctermfg=Red
hi Statement	guifg=blue gui=bold ctermfg=Blue
hi PreProc	guifg=darkred gui=none ctermfg=darkGreen
